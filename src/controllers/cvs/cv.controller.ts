...
export const getMyCvs = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const createCv = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getCvById = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const setCvStatus = async (req: Request, res: Response, next: NextFunction) => {
  try {
